                    ...
                    {subtask.are_stats_public && (
                        <div className="form__col-left__one-third">
                            <ul>
                                ...
                                <li>
                                    Upvotes: <span>{subtask.upvotes_count}</span>
                                </li>
                                <li>
                    ...
                    <div className="form__col-public">
                        ...
                        {subtask.attachments && subtask.attachments.length > 0 && (
                            <div className="form__attachments">
                                <h4>Attachments ({subtask.attachments.length})</h4>
                                {subtask.attachments.map((attachment, idx) => (
                ...
                <>
                    <div className="form__col-left__one-third">
                        <ul>
                            ...
                            <li>
                                Type:{' '}
                                <span style={{ color: getTypeColor(subtask.task_type.title) }}>
                                    {subtask.task_type.title}
                                </span>
                            </li>
                            <li>
                                Visibility: <span>{capitalizeFirstLetter(subtask.visibility)}</span>
                            </li>
                            {subtask.are_stats_public && (
                                <>
                                    <li>
                    ...
                    <div className="form__col-public">
                        {hasDescriptionContent(subtask.description) && (
                        ...
                        {subtask.team_members && subtask.team_members.length > 0 && (
                            <div className="form__team-members-readonly">
                                <h4>Team Member(s)</h4>
                                <div className="form__members-list">
                                    {subtask.team_members.map((member) => (
                                        <TooltipUserAvatar
                                            key={member.id}
                                            user={member}
                        ...
                        {subtask.community_members && subtask.community_members.length > 0 && (
                            <div className="form__contributors-readonly">
                                <h4>Contributors</h4>
                                <div className="form__members-list">
                                    {subtask.community_members.map((member) => (
                                        <TooltipUserAvatar
                                            key={member.id}
                                            user={member}
                                            isUsernameVisible={true}
                        ...
                        {methods.watch('are_stats_public') && (
                            <div className="form__row-text">
                                <FormRectangle title="Upvotes">
                                    {subtask.upvotes_count}
                                </FormRectangle>
                                <FormRectangle title="Feedback & Suggestions">
                                    <i>Submitted:</i> {subtask.comments_count}
                                    <i>Highlighted:</i>{' '}
                                    {subtask.highlighted_comments_count}
                                </FormRectangle>
                            </div>
...
export default FormEditSubtaskLeftCol;
