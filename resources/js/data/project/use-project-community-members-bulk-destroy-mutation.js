...
const useProjectCommunityMembersBulkDestroyMutation = (
    projectSlug,
    currentTablePage,
    queryArgs
) => {
    ...
    return useMutation(
        (payload) =>
            deleteData(`/api/${projectSlug}/community-members`, payload),
        {
            onSettled: () => {
...
export default useProjectCommunityMembersBulkDestroyMutation;
