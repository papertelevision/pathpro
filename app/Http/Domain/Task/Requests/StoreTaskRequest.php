...
class StoreTaskRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'are_subtasks_allowed' => 'required|boolean',
            ...
            'has_first_comment' => 'required|boolean',
            'comment_content' => 'required_if:has_first_comment,true',
            'is_comment_pinned_to_top' => 'required_if:has_first_comment,true',
